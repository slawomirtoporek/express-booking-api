const db = {
  ...
  concerts: [
    ...
    { id: '6342a95c-2f36-42e9-9489-4b9386e2ac3f', performer: 'Maybell Haley', genre: 'Pop', price: 40, day: 1, image: '/img/uploads/hdfh42sd213.jpg' },
  ],
  seats: [
    ...
    { id: 'd47bbd88-50b1-4bed-999e-88e84eb3dd43', day: 2, seat: 2, client: 'Molier Lo Celso', email: 'moiler.lo.celso@example.com'  },
  ],
};
